...
module.exports.$AI = module.exports.psLib
                   = module.exports.AlloyImage
                   = module.exports.window[Ps]
                   = window[Ps];

require('./module/addLayer');
require('./module/applyMatrix');
require('./module/config');
require('./module/dorsyMath');
require('./module/dorsyWorker');
require('./module/easy');
require('./module/fix');
require('./module/tools');
// alteration
require('./module/alteration/brightness');
require('./module/alteration/curve');
require('./module/alteration/gamma');
require('./module/alteration/seletiveColor');
require('./module/alteration/setHSI');
// filter
require('./module/filter/corrode');
require('./module/filter/darkCorner');
require('./module/filter/dotted');
require('./module/filter/embossment');
require('./module/filter/ImageEnhance');
require('./module/filter/mosaic');
require('./module/filter/noise');
require('./module/filter/oilPainting');
require('./module/filter/posterize');
require('./module/filter/sepia');
require('./module/filter/sharp');
require('./module/filter/toGray');
require('./module/filter/toReverse');
require('./module/filter/toThresh');